            ...
            <div className="row container">
                ...
                <div className="col s12 m6 l4">
                    <Link to={"/anime/" + this.props.item1}>
                        ...
                        <img src={"./imgs/" + this.props.item1 + "_.png"} className="responsive-img card"></img>
                    </Link>
                </div>
                <div className="col s12 m6 l4">
                    <Link to={"/anime/" + this.props.item2}>
                        <h6 className="teal-text">Anime Name 2</h6>
                        <img src={"./imgs/" + this.props.item2 + "_.png"} className="responsive-img card"></img>
                    </Link>
                </div>
                <div className="col s12 m6 l4">
                    <Link to={"/anime/" + this.props.item3}>
                        <h6 className="teal-text">Anime Name 3</h6>
                        <img src={"./imgs/" + this.props.item3 + "_.png"} className="responsive-img card"></img>
                    </Link>
                </div>
                <div className="col s12 m6 l4">
                    <Link to={"/anime/" + this.props.item1}>
